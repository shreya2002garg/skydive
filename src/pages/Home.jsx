...
import MovingDivs from '../components/MovingDivs'
    ...
    <div className=" px-0">
      ...
      <div className="relative w-full h-[50vh] sm:h-[60vh] md:h-[70vh] lg:h-[80vh] flex items-start justify-start mb-8">
        ...
        <div className="relative z-10 mt-14 text-left text-white p-8 md:p-16 lg:p-20 max-w-[50%]">
          <h2 className="text-[32px]  text-blue-300 sm:text-[40px] md:text-[50px] lg:text-[60px] font-semibold mb-4 leading-tight">
            Aerial robotics.
          </h2>
      ...
      <div className="mt-20 md:mt-40">
        ...
        <button className="bg-black text-white px-4 py-2 mt-10 ml-10 md:ml-20">See More Customer Stories</button>
      </div>
      <div className='mt-10 mb-20'>
        <h1 className='text-[70px] mb-20 text-center ml-auto mr-auto font-medium w-[60%]'>Join the industry leaders that choose Skydio.</h1>
        <MovingDivs />
      </div>
      <div className='bg-gray-100 p-4 pt-20'>
        <h1 className='text-[60px] text-center'>Start a conversation with our team.</h1>
        <button className='mt-20 ml-[50%] mb-5 bg-black text-white px-6 py-3' onClick={toggleSidebar}>Contact Us</button>
      </div>
